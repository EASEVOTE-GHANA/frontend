...
export default function ReportsClient() {
  ...
  const handleDownload = async (report: ReportCard) => {
    ...
    try {
      ...
      a.href = url;
      const ext = report.title.includes("PDF") ? "pdf" : "csv";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-20">
